...
public class Ping
{
	...
	(byte i, byte i_0_, byte i_1_, byte i_2_, long l) throws Throwable {
	...
	(byte i, byte i_7_, byte i_8_, byte i_9_, long l) throws Throwable {
    ...
    public static int method682
	(byte i, byte i_11_, byte i_12_, byte i_13_, long l) throws Throwable {
