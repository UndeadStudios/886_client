...
public class NPCDefinitions implements Interface12 {
    ...
    NPCDefinitions(int i, SunDefinition class308, Interface13 interface13) {
        anInt3313 = -879390592;
        aBool3314 = false;
        aBool3294 = false;
        aBool3316 = false;
        ...
        aStringArray3307 = aClass308_3287.aStringArray3420.clone();
    }
            ...
            for (int i_28_ = 0; i_28_ < i_26_; i_28_++) {
                if (0 == (i_25_ & 1 << i_28_)) {
                    ...
                    aShortArray3356[i_28_]
                            = (short) class525_sub38.readSmart2(982783173);
                }
            }
        } else if (i == 103)
            ...
            if (163 == i)
                ...
                if (179 == i) {
                    ...
                    aClass443_3352.aFloat4877
                            = (float) class525_sub38.readSmart3(993241788);
                    ...
                    for (int i_40_ = 0; i_40_ < i_38_; i_40_++) {
                        ...
                        aClass10_3286.method695(class525, i_41_);
                    }
                }
            }
        }
            ...
            for (int i_65_ = 0; i_65_ < i_63_; i_65_++) {
                if (0 == (i_62_ & 1 << i_65_)) {
                    ...
                    aShortArray3356[i_65_]
                            = (short) class525_sub38.readSmart2(677571603);
                }
            }
        } else if (i == 103)
            ...
            if (163 == i)
                ...
                if (179 == i) {
                    ...
                    for (int i_77_ = 0; i_77_ < i_75_; i_77_++) {
                        ...
                        aClass10_3286.method695(class525, i_78_);
                    }
                }
            }
        }
    ...
    public final Class179 method5365
        ...
        if (class179 == null || (class179.method2928() & i_83_) != i_83_) {
            ...
            if (bool_89_)
                return null;
            ModelDecoder[] class186s = new ModelDecoder[is_88_.length];
            for (int i_91_ = 0; i_91_ < is_88_.length; i_91_++) {
                if (-1 != is_88_[i_91_]) {
                    synchronized (aClass308_3287.aClass458_3421) {
                        class186s[i_91_]
                                = ModelDecoder.method3644((aClass308_3287
                                        .aClass458_3421),
                                is_88_[i_91_], 0);
                    }
                    if (null != class186s[i_91_]) {
                        if (class186s[i_91_].version < 13)
    ...
    public int method5368(int i, int i_113_, byte i_114_) {
        ...
        Class525_Sub42 class525_sub42
                = (Class525_Sub42) aClass10_3286.method684(i);
            ...
            for (int i_138_ = 0; i_138_ < i_136_; i_138_++) {
                if (0 == (i_135_ & 1 << i_138_)) {
                    ...
                    aShortArray3356[i_138_]
                            = (short) class525_sub38.readSmart2(1210272412);
                }
            }
        } else if (i == 103)
            ...
            if (163 == i)
                ...
                if (179 == i) {
                    ...
                    for (int i_150_ = 0; i_150_ < i_148_; i_150_++) {
                        ...
                        aClass10_3286.method695(class525, i_151_);
                    }
                }
            }
        }
    ...
    public boolean method5371(Interface20 interface20, Interface18 interface18,
		...
		return -1 != anIntArray3323[i_154_];
	}
    ...
    public final Class179 method5372
        ...
        if (class179 == null || (class179.method2928() & i_161_) != i_161_) {
            ...
            if (bool_167_)
                return null;
            ModelDecoder[] class186s = new ModelDecoder[is_166_.length];
            for (int i_169_ = 0; i_169_ < is_166_.length; i_169_++) {
                if (-1 != is_166_[i_169_]) {
                    ...
                    if (null != class186s[i_169_]) {
                        if (class186s[i_169_].version < 13)
    ...
    public String method5373(int i, String string) {
        ...
        Class525_Sub19 class525_sub19
                = (Class525_Sub19) aClass10_3286.method684(i);
        ...
        if (class179 == null || (class179.method2928() & i_196_) != i_196_) {
            ...
            synchronized (aClass308_3287.aClass458_3421) {
                for (int i_199_ = 0; i_199_ < is.length; i_199_++)
                    class186s[i_199_]
                            = ModelDecoder.method3644(aClass308_3287.aClass458_3421,
                            is[i_199_], 0);
            }
            for (int i_200_ = 0; i_200_ < is.length; i_200_++) {
                if (null != class186s[i_200_]
                        && class186s[i_200_].version < 13)
    ...
    public final NPCDefinitions method5385(Interface20 interface20,
                                           Interface18 interface18) {
        int i = -1;
    ...
    public final NPCDefinitions method5386(Interface20 interface20,
        ...
        if (anIntArray3323[i_220_] == -1)
            return null;
        return (NPCDefinitions) anInterface13_3349.method76(anIntArray3323[i_220_],
                1130592826);
    }
    ...
    public boolean method5387() {
        ...
        for (int i = 0; i < anIntArray3323.length; i++) {
            if (anIntArray3323[i] != -1) {
                NPCDefinitions class299_222_
                        = (NPCDefinitions) anInterface13_3349.method76(anIntArray3323[i],
                        558338358);
