...
public class Class56
{
	...
	return 289049441 * anInt611;
    }
    
    Class56(int i, String string, boolean bool, boolean bool_0_,
	    boolean bool_1_) {
	anInt611 = i * 761616545;
	aBool597 = bool_1_;
    }
    
    public boolean method1194(int i) {
	return aBool597;
    }
    ...
    public int method1201() {
	return 289049441 * anInt611;
    }
    
    public int method1202(int i) {
	return 289049441 * anInt611;
    }
    
    public boolean method1203() {
	return aBool597;
    }
    
    static final void method1204(Class683 class683, short i) {
	...
	if (class299.anIntArray3323 != null)
		...
		= class299.method5386(Class532.aClass111_7170,
				      Class532.aClass111_7170, 2102778536);
	if (null != class299)
	    bool = class299.aBool3326;
