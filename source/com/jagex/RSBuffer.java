...
public class RSBuffer extends Class525
{
	...
	index += 1357713884;
	return ((buffer[-1133521593 * index - 4] & 255)
		+ (((buffer[index * -1133521593 - 1] & 255)
		    << 24)
		   + ((buffer[-1133521593 * index - 2] & 255)
		      << 16)
		   + ((buffer[index * -1133521593 - 3] & 255)
		      << 8)));
    }
	...
	index
	    += Class281.method5198(buffer, -1133521593 * index,
	...
	if (i < 0 || i > 65535)
	    throw new IllegalArgumentException();
	buffer[index * -1133521593 - i - 2] = (byte) (i >> 8);
	buffer[-1133521593 * index - i - 1] = (byte) i;
    }
	...
	index = 339428471 * i_25_;
    }
    
    public int method16619() {
	index += 1357713884;
	return (((buffer[-1133521593 * index - 4] & 255) << 16)
		+ ((buffer[index * -1133521593 - 3] & 255)
		   << 24)
		+ ((buffer[index * -1133521593 - 1] & 255) << 8)
		+ (buffer[index * -1133521593 - 2] & 255));
    }
	...
	if (i == -1)
	    ...
	    buffer[-1133521593 * index - 4] |= 0x80;
	}
    }
	...
	int i_35_ = buffer[index * -1133521593] & 255;
	if (i_35_ < 128)
	...
	index += 678856942;
	int i_36_ = ((buffer[-1133521593 * index - 1] & 255)
		     + ((buffer[index * -1133521593 - 2] & 255)
			<< 8));
	if (i_36_ > 32767)
	    i_36_ -= 65536;
	...
	int i = buffer[index * -1133521593] & 255;
	if (i < 128)
	...
	int i_41_ = index * -1133521593;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_42_ = index * -1133521593 - i_41_ - 1;
	if (i_42_ == 0)
	    return "";
	...
	int i_44_ = -1133521593 * index;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_45_ = -1133521593 * index - i_44_ - 1;
	if (0 == i_45_)
	    return "";
	...
	if (i_47_ + index * -1133521593 > buffer.length)
	    throw new IllegalStateException("");
	String string = Class531_Sub3.method15943(buffer,
						  -1133521593 * index,
						  i_47_, (byte) 31);
	index += 339428471 * i_47_;
	return string;
    }
    
    public void readBytes(byte[] is, int i, int i_48_, int i_49_) {
	for (int i_50_ = i; i_50_ < i_48_ + i; i_50_++)
	    is[i_50_]
		= buffer[(index += 339428471) * -1133521593 - 1];
    }
    
    public int readSmart3(int i) {
	int i_51_ = buffer[-1133521593 * index] & 255;
	if (i_51_ < 128)
	...
	method16614(class525_sub38_54_.buffer, 0,
		    -1133521593 * class525_sub38_54_.index, 1080425538);
    }
	...
	index += 1357713884;
	return (((buffer[index * -1133521593 - 4] & 255) << 24)
		+ ((buffer[index * -1133521593 - 3] & 255)
		   << 16)
		+ ((buffer[index * -1133521593 - 2] & 255) << 8)
		+ (buffer[-1133521593 * index - 1] & 255));
    }
	...
	index += 678856942;
	return ((buffer[-1133521593 * index - 1] - 128 & 255)
		+ ((buffer[-1133521593 * index - 2] & 255)
		   << 8));
    }
	...
	index += 678856942;
	return (((buffer[-1133521593 * index - 1] & 255) << 8)
		+ (buffer[index * -1133521593 - 2] - 128
		   & 255));
    }
    
    public int method16669(short i) {
	index += 678856942;
	int i_90_ = ((buffer[index * -1133521593 - 2] & 255)
		     + ((buffer[-1133521593 * index - 1] & 255)
			<< 8));
	if (i_90_ > 32767)
	    i_90_ -= 65536;
	...
	int i_91_
	    = (((buffer[index * -1133521593 - 1] & 255) << 8)
	       + (buffer[index * -1133521593 - 2] - 128 & 255));
	if (i_91_ > 32767)
	    i_91_ -= 65536;
	return i_91_;
    }
    ...
    public void method16671(BigInteger biginteger, BigInteger biginteger_92_,
			    short i) {
	int i_93_ = index * -1133521593;
	index = 0;
	byte[] is = new byte[i_93_];
	readBytes(is, 0, i_93_, 392537369);
	...
	index += 1018285413;
	return ((buffer[-1133521593 * index - 2] & 255)
		+ (((buffer[index * -1133521593 - 3] & 255)
		    << 16)
		   + ((buffer[-1133521593 * index - 1] & 255)
		      << 8)));
	...
	index += 1357713884;
	return (((buffer[-1133521593 * index - 4] & 255) << 8)
		+ (((buffer[index * -1133521593 - 1] & 255)
		    << 16)
		   + ((buffer[-1133521593 * index - 2] & 255)
		      << 24))
		+ (buffer[-1133521593 * index - 3] & 255));
    }
	...
	index += 678856942;
	return ((buffer[index * -1133521593 - 2] & 255)
		+ ((buffer[-1133521593 * index - 1] & 255)
		   << 8));
    }
	...
	index += 1018285413;
	int i_107_
	    = (((buffer[-1133521593 * index - 3] & 255) << 16)
	       + ((buffer[-1133521593 * index - 2] & 255) << 8)
	       + (buffer[index * -1133521593 - 1] & 255));
	if (i_107_ > 8388607)
	    i_107_ -= 16777216;
	return i_107_;
	...
	index += 678856942;
	int i = ((buffer[-1133521593 * index - 1] & 255)
		 + ((buffer[index * -1133521593 - 2] & 255)
		    << 8));
	if (i > 32767)
	    i -= 65536;
	...
	method16614(class525_sub38_117_.buffer, 0,
		    -1133521593 * class525_sub38_117_.index, 383293120);
    }
	...
	method16614(class525_sub38_118_.buffer, 0,
		    -1133521593 * class525_sub38_118_.index, 2135078165);
    }
    
    public void method16717(RSBuffer class525_sub38_119_) {
	method16614(class525_sub38_119_.buffer, 0,
		    -1133521593 * class525_sub38_119_.index, 496160023);
    }
	...
	int i_121_ = 0;
	for (/**/; i < 0;
	     i = buffer[(index += 339428471) * -1133521593 - 1])
	...
	int i_130_ = buffer[index * -1133521593] & 255;
	if (i_130_ < 128)
	...
	index += 678856942;
	return (((buffer[index * -1133521593 - 2] & 255) << 8)
		+ (buffer[index * -1133521593 - 1] & 255));
    }
	...
	index += 1018285413;
	return (((buffer[-1133521593 * index - 2] & 255) << 8)
		+ ((buffer[-1133521593 * index - 3] & 255)
		   << 16)
		+ (buffer[index * -1133521593 - 1] & 255));
    }
	...
	index += 1357713884;
	return ((buffer[index * -1133521593 - 4] & 255)
		+ (((buffer[-1133521593 * index - 1] & 255)
		    << 24)
		   + ((buffer[-1133521593 * index - 2] & 255)
		      << 16)
	...
	byte i = buffer[(index += 339428471) * -1133521593 - 1];
	if (0 != i)
	    throw new IllegalStateException("");
	int i_143_ = -1133521593 * index;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_144_ = -1133521593 * index - i_143_ - 1;
	if (0 == i_144_)
	    return "";
	...
	method16614(class525_sub38_152_.buffer, 0,
		    -1133521593 * class525_sub38_152_.index, 1747064319);
    }
	...
	int i = index * -1133521593;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_156_ = index * -1133521593 - i - 1;
	if (i_156_ == 0)
	    return "";
	...
	int i_157_ = index * -1133521593 - i - 1;
	if (i_157_ == 0)
	    return "";
	...
	int i_158_ = index * -1133521593 - i - 1;
	if (i_158_ == 0)
	    return "";
	...
	if (0 != i)
	    throw new IllegalStateException("");
	int i_159_ = -1133521593 * index;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_160_ = -1133521593 * index - i_159_ - 1;
	if (0 == i_160_)
	    return "";
	...
	if (0 != i)
	    throw new IllegalStateException("");
	int i_161_ = -1133521593 * index;
	while (buffer[(index += 339428471) * -1133521593 - 1]
	       != 0) {
	    /* empty */
	}
	int i_162_ = -1133521593 * index - i_161_ - 1;
	if (0 == i_162_)
	    return "";
	...
	if (i_163_ + index * -1133521593 > buffer.length)
	    throw new IllegalStateException("");
	String string = Class531_Sub3.method15943(buffer,
						  -1133521593 * index,
						  i_163_, (byte) 32);
	index += 339428471 * i_163_;
	return string;
    }
	...
	if (i_164_ + index * -1133521593 > buffer.length)
	    throw new IllegalStateException("");
	String string = Class531_Sub3.method15943(buffer,
						  -1133521593 * index,
						  i_164_, (byte) 114);
	index += 339428471 * i_164_;
	return string;
    }
    
    public int method16777(int i) {
	int i_165_ = Class555.method9240(buffer, i,
					 -1133521593 * index, (byte) -40);
	method16605(i_165_, -1238418540);
	return i_165_;
    }
    
    public int method16778() {
	int i = buffer[-1133521593 * index] & 255;
	if (i < 128)
	...
	int i = 0;
	int i_166_;
	for (i_166_ = readUnsignedSmart((byte) -98); i_166_ == 32767;
		 i_166_ = readUnsignedSmart((byte) -62))
	    i += 32767;
	i += i_166_;
	return i;
    }
	...
	index += 678856942;
	int i = ((buffer[index * -1133521593 - 2] & 255)
		 + ((buffer[-1133521593 * index - 1] & 255)
		    << 8));
	if (i > 32767)
	    i -= 65536;
	...
	int i_219_ = 0;
	int i_220_;
	for (i_220_ = readUnsignedSmart((byte) -4); i_220_ == 32767;
		 i_220_ = readUnsignedSmart((byte) -15))
	    i_219_ += 32767;
	i_219_ += i_220_;
	return i_219_;
    }
