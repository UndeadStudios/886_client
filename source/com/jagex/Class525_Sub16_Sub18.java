...
{
    static Class458 aClass458_11870;
    static Class458 aClass458_11871;
    int anInt11872;
    byte[][] aByteArrayArray11873;
    Class177[] aClass177Array11874;
    
    public boolean method18479(int i) {
	return aClass177Array11874[i].aBool1899;
    }
	...
	return aClass177Array11874[i].aBool1901;
    }
    ...
    public static void method18483(Class458 class458, Class458 class458_2_,
				   int i) {
	...
	if (aByteArrayArray11873 == null) {
		...
		for (int i = 0; i < is.length; i++)
			...
			= aClass458_11871.method7476(anInt11872 * -629092491,
						     is[i], 1695036699);
	    }
	}
	boolean bool = true;
	...
	synchronized (aClass458_11871) {
	    int i = aClass458_11871.method7487(anInt11872 * -629092491,
					       2136505378);
	    aClass177Array11874 = new Class177[i];
	...
	for (int i = 0; i < is.length; i++) {
	    ...
	    Class525_Sub14 class525_sub14 = null;
	    for (Class525_Sub14 class525_sub14_6_
		     = (Class525_Sub14) class709.method14372((short) -13177);
		 null != class525_sub14_6_;
		 class525_sub14_6_
		     = (Class525_Sub14) class709.method14353(-1119070312)) {
		if (-2087764181 * class525_sub14_6_.anInt10543 == i_5_) {
		...
		synchronized (aClass458_11870) {
		    class525_sub14
			= new Class525_Sub14(i_5_, (aClass458_11870.method7484
						    (i_5_, 1384840409)));
		}
		class709.method14345(class525_sub14, (byte) 0);
	    }
	    aClass177Array11874[is[i]] = new Class177(is_4_, class525_sub14);
	}
	...
	synchronized (aClass458_11871) {
	    int i_10_ = aClass458_11871.method7487(anInt11872 * -629092491,
						   2137322192);
	    aClass177Array11874 = new Class177[i_10_];
	    is = aClass458_11871.method7540(anInt11872 * -629092491,
					    -1429695635);
	}
	for (int i_11_ = 0; i_11_ < is.length; i_11_++) {
	    ...
	    Class525_Sub14 class525_sub14 = null;
	    for (Class525_Sub14 class525_sub14_14_
		     = (Class525_Sub14) class709.method14372((short) -31499);
		 null != class525_sub14_14_;
		 class525_sub14_14_
		     = (Class525_Sub14) class709.method14353(-1982855882)) {
		if (-2087764181 * class525_sub14_14_.anInt10543 == i_13_) {
		...
		synchronized (aClass458_11870) {
		    class525_sub14
			= new Class525_Sub14(i_13_, (aClass458_11870.method7484
						     (i_13_, 2138118013)));
		}
		class709.method14345(class525_sub14, (byte) 0);
	    }
	    aClass177Array11874[is[i_11_]]
		= new Class177(is_12_, class525_sub14);
	}
	aByteArrayArray11873 = null;
	return true;
    }
